---
name: calentamiento-movilidad
description: "Warm-up and mobility protocols."
---
...
**Objetivo**: Ligeramente sudando, FC ~100-120 bpm. NO agotar.
...
Para tu PRIMER ejercicio compuesto del dia:

| Serie | % del peso de trabajo | Reps | Descanso |
|-------|-----------------------|------|----------|
| Serie 1 | ~40-50% | 8-10 | 30-45 seg |
...
2. Frog stretch: 30-45 seg
3. Cossack squat sin peso: 2x6/lado
4. Pigeon stretch: 30 seg/lado
...
- Simic et al. (2013) — Static stretching reduces maximal muscle force
- Behm et al. (2016) — Acute effects of stretching on performance
- Opplert & Babault (2018) — Stretching and performance review
