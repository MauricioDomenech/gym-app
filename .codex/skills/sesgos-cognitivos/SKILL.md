...
Los sesgos cognitivos afectan TANTO a quien da el consejo como a quien lo recibe. Un coach excelente puede tener sesgo de confirmacion. Un usuario puede tener sesgo de supervivencia por las fotos de Instagram. Este skill ayuda a detectar y neutralizar estos sesgos.
...
**Ejemplo**: "CrossFit te pone en la mejor forma de tu vida" → Solo ves a los que sobrevivieron sin lesiones.

**Correccion**: "¿Que paso con los que hicieron lo mismo y no tuvieron ese resultado?"
...
**Correccion**: Presentar multiples perspectivas basadas en evidencia actual antes de emitir juicio.
...
### 8. Efecto nocebo/placebo

**Que es**: Atribuir efectos positivos o negativos a sustancias/metodos sin mecanismo real.

**Como detectarlo**:
- "Desde que deje el gluten me siento increible" (sin ser celiaco ni sensible)
- "Este suplemento me cambio la vida" (sin grupo control)
- Atribuir efectos a un alimento demonizado sin base mecanistica

**Ejemplo**: "Tome ashwagandha y al tercer dia dormia mejor" (efecto placebo — la ashwagandha tarda semanas en actuar, si es que actua).

**Correccion**: Verificar si existe mecanismo bioquimico real y timing plausible.
...
### 10. Sesgo de costo hundido

**Que es**: Seguir con algo que no funciona porque ya invertiste tiempo/dinero/esfuerzo.

**Como detectarlo**:
- "Llevo 6 meses con keto, no puedo dejarlo ahora"
...
### 12. Sesgo de generalizacion apresurada

**Que es**: De un caso/estudio/experiencia a "asi funciona para todos".
...
SESGOS DETECTADOS:
1. [Sesgo]: [como aplica] → Correccion: [que deberia decir]
2. [Sesgo]: [como aplica] → Correccion: [que deberia decir]

SESGOS DEL RECEPTOR (usuario):
- Posible [sesgo] porque [contexto del usuario]

RECOMENDACION CORREGIDA:
"[version sin sesgos, con matices apropiados]"
```

## Fuentes
- PSB Academy — Cognitive Bias in Nutrition and Sport Coaching
- EliteFTS — The Dangers of Confirmation Bias in Fitness
- Troscriptions — Top 7 Cognitive Biases in Health and Wellness
- Weightology — Confirmation Bias in Fitness
- PMC (2023) — Impact of Bias on Healthy Lifestyles
- Tandfonline (2023) — Dunning-Kruger in Health Communication
