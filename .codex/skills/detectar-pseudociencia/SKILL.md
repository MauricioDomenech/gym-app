---
name: detectar-pseudociencia
description: "Detect pseudoscience and marketing claims."
---
...
| 9 | Presion de urgencia para comprar | "Solo hoy, plazas limitadas, oferta exclusiva" |
| 10 | Demonizacion absoluta de un alimento/macronutriente | "Los carbohidratos son veneno", "el gluten destruye tu intestino" |
...
## Pseudociencia comun en fitness (catalogo)

### Productos/metodos SIN evidencia
...
- Si pasa los 3 pasos anteriores sin alertas: buscar en PubMed/Examine
- Si falla en cualquier paso: marcar como sospechoso y usar herramientas web disponibles para buscar "[claim] debunked"
...
```
ANALISIS DE PSEUDOCIENCIA
=========================

Afirmacion: "[texto original]"
Fuente: [quien lo dice]

RED FLAGS DETECTADAS: [X/10]
- [Red flag 1]: [como aplica]
- [Red flag 2]: [como aplica]

FALACIAS IDENTIFICADAS:
- [Falacia 1]: [como aplica]
- [Falacia 2]: [como aplica]
...
## Fuentes
- Skeptical Inquirer — Ten Health and Wellness Fallacies
- PMC — Baseless Claims in Sports/Exercise/Nutrition Science (2022)
- Nature Metabolism (2025) — Nutritional Advice on Social Media
- Brown University Health — Identifying Nutrition Misinformation
- MySportScience — How Pseudoscience is Harming Your Practice
