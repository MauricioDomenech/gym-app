---
name: ciclado-carbohidratos
description: Protocolo de carb cycling (ciclado de carbohidratos) dia a dia para recomposicion corporal. Usa cuando pregunten sobre carb cycling, variar carbohidratos segun el dia, o quieran una estrategia avanzada de nutricion.
---
...
### NO es para ti
- Principiantes (primero dominar macros fijos)
- Personas que les cuesta adherirse a un plan simple
- Si te genera estres o ansiedad calcular macros diferentes cada dia
- Si ya pierdes grasa con macros fijos (no arregles lo que funciona)

---

## Diferencia con Refeeds
...
| Miercoles | Legs (Fuerza) | ALTO | 2500 | 160g (2.0g/kg) | 340g (4.25g/kg) | 53g (0.66g/kg) |
| Jueves | Push (Hipertrofia) | MEDIO | 2200 | 176g | 220g | 72g |
| Viernes | Pull (Hipertrofia) | MEDIO | 2200 | 176g | 220g | 72g |
...
## Plantilla PPL x2 con carb cycling

```
SEMANA TIPO
==========
Lun (Push Fuerza)    → DIA MEDIO
Mar (Pull Fuerza)    → DIA MEDIO
Mie (Legs Fuerza)    → DIA ALTO
Jue (Push Hiper)     → DIA MEDIO
Vie (Pull Hiper)     → DIA MEDIO
Sab (Legs Hiper)     → DIA ALTO
Dom (Descanso)       → DIA BAJO
```
